<!--
 - third-party.vue
 - 
 - sobird<i@sobird.me> at 2020/10/27 13:39:17 created.
-->
...
<template>
  <el-row :gutter="10">
    <el-col :span="8">
      <h3>
        Integration with
        <a href="https://element.eleme.io/#/en-US/component/collapse#collapse" target="_blank">
          Element collapse
        </a>
      </h3>
      ...
      >
        <template #item="{ element }">
          <el-collapse-item :key="element.id" :title="element.title" :name="element.id">
    ...
    <el-col :span="8">
      <h3>ActiveNames</h3>
      <MonacoEditor v-model="activeNamesText" style="height: 400px;" />
    </el-col>
  </el-row>
</template>
...
export default {
  ...
  computed: {
    ...
    activeNamesText: {
      get() {
        return JSON.stringify(this.activeNames, null, 2);
      },
      set() {},
    },
  },
