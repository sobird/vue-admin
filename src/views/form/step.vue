...
<template>
  <div>
    ...
    <el-row type="flex">
      ...
      <el-col :span="12">
        <el-form ref="stepForm" :model="stepFormModel" :rules="stepFormRules" label-width="110px">
          <div v-if="stepNum == 0">
            ...
            <el-form-item label="转账金额：" prop="transferAmount">
              <el-input v-model.number="stepFormModel.transferAmount">
          ...
          <div v-if="stepNum == 1" class="form-confirm">
            ...
            <el-form-item label="转账金额：" prop="transferAmount">
              <span class="amount">{{ stepFormModel.transferAmount }}</span>
              元
            </el-form-item>
          ...
          <div v-if="stepNum == 2" class="form-result">
            ...
            <div class="form-action">
              ...
              <el-button @click="() => {}">查看账单</el-button>
            </div>
          </div>
        </el-form>
      </el-col>
