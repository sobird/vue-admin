 ...
 * 整站布局文件
 * 
 * @author  Yang,junlong at 2018-08-08 10:27:32 build.
 * @version $Id$
-->
<template>
  <div
    id="mix-layout"
    :class="['mix-layout-has-sidebar', {'sidebar-collapse': $store.state.sidebar.collapse}]"
  >
      ...
      <el-scrollbar ref="contentScrollbar" class="content-scrollbar" wrapClass="scrollbar-wrapper">
        ...
        <div class="main-content">
          <div class="main-view-container">
            <div class="main-view">
              <router-view v-view-title="$route.meta.title" :key="$store.state.viewkey" />
            </div>
          </div>
          <div class="footer">
            <p>Copyright&nbsp;©&nbsp;{{(new Date).getFullYear()}}&nbsp;中台技术部</p>
            <p>
              Powered by
              <a href="https://cn.vuejs.org/" target="_blank">Vue</a>. FE
            </p>
          </div>
        </div>
      </el-scrollbar>
...
/**
 * Cascader 级联选择器 选择任意一级优化
 * @see https://sobird.me/element-ui-cascader-any-level.htm
 */
.el-cascader-menu {
  .el-radio,
  .el-checkbox {
